...
rc.exe resources.rc
cl /EHsc /O2 /W3 /std:c++17 /utf-8 /D_UNICODE /DUNICODE /MD main.cpp resources.res /link user32.lib shell32.lib gdi32.lib ole32.lib comctl32.lib shlwapi.lib /DYNAMICBASE /NXCOMPAT /OUT:EncodingConverter.exe
